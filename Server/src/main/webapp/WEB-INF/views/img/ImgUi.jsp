	...
	<div class="crud_area">
		<div class="crud_area_box">
			...
			<table class="table_area">
				...
				<tr>
					<td colspan="4">
					<input type="button" value="조회" id="btnSelect" class="button">
						 <input type="button" value="초기화" id="btnInit" class="button">
						 <input type="button" value="추가" id="btnInsert" class="button add">
						 <input type="button" value="삭제" id="btnDelete" class="button delete"></td>
				</tr>
				<tr>
					<td>idx</td>
					...
					<td><input type="text" id="imgName" maxlength="100" class="input">
						<input type="button" id="btnImgSelect" maxlength="100" class="button" value="선택">
					</td>
				</tr>
