...
// Format a selected USB by using VDS
//BOOL DeletePartitions(IVdsService* pService, int device, std::string& drive_name, std::string& volume_name)
...
// Load VDS
//int getVds(int device, std::string& drive_name, std::string& volume_name)
